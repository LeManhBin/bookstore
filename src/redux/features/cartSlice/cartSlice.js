...
export const actFetchAllDataCartByIdUser = createAsyncThunk(
  "cart/actFetchAllDataCartByIdUser",
  async (id) => {
...
export const actChangeQuantity =
  (item, quantity, idUser) => async (dispatch) => {
    try {
      dispatch(actUpdateLoadingCreate(true));
