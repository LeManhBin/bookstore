...
import { fetchCreateEvaluate, fetchDataEvaluateByIdBook } from "../../../apis/evaluateApi";
...
export const actFetchDataEvaluateByIdBook = createAsyncThunk('evaluate/actFetchDataEvaluateByIdBook', async (id) => {
