...
export const actFetchAllTopic = createAsyncThunk('topic/actFetchAllTopic', async () => {
    const data = await fetchAllDataTopic()
    return data || []
})

export const actFetchTopicById = createAsyncThunk('topic/actFetchTopicById', async (id) => {
