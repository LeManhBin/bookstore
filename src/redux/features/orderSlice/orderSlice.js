...
export const actFetchOrderUserByStatus = createAsyncThunk(
  "order/actFetchOrderUserByStatus",
  async (id) => {
...
export const actFetchOrderByIdStore = createAsyncThunk(
  "order/actFetchOrderByIdStore",
  async (id) => {
...
export const actFetchOrderDetail = createAsyncThunk(
  "order/actFetchOrderDetail",
  async (id) => {
...
export const actChangeOrderStatus =
  (id, status, idStore) => async (dispatch) => {
    try {
      dispatch(actUpdateLoadingCreate(true));
...
export const actReviewDoneChangeStatus =
  (id, status, idUser) => async (dispatch) => {
    try {
      dispatch(actUpdateLoadingCreate(true));
      await fetchChangeOrderStatus(id, status);
      dispatch(actFetchOrderUserByStatus(idUser));
