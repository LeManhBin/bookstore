...
export const actFetchAllContact = createAsyncThunk(
  "contact/actFetchAllContact",
  async () => {
...
export const actFetchContactById = createAsyncThunk(
  "contact/actFetchContactById",
  async (id) => {
